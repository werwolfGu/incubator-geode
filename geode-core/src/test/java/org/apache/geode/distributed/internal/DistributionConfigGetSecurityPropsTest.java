...
public class DistributionConfigGetSecurityPropsTest {
  ...
  public void shouldAllowDistributionConfigKeys() {
    ...
    Properties securityProps = config.getSecurityProps();
    assertThat(securityProps).containsOnlyKeys(SECURITY_CLIENT_ACCESSOR_NAME, SECURITY_CLIENT_ACCESSOR_PP_NAME, SECURITY_CLIENT_AUTH_INIT_NAME, SECURITY_CLIENT_AUTHENTICATOR_NAME, SECURITY_PEER_AUTH_INIT_NAME, SECURITY_PEER_AUTHENTICATOR_NAME, SECURITY_PEER_VERIFYMEMBER_TIMEOUT_NAME);
